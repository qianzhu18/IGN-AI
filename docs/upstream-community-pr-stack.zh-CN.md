...
| 1 | Content Type Registry | 待拆 | P0 | Member/Event 类型判断分散 |
...
1. 跟进 #4169，争取合并或按维护者反馈缩小范围。
2. 从 `notionnext/main` 拆 PR 1：Content Type Registry。
3. 同步写一篇短复盘，把“从博客到 AI 社区基础设施”的叙事公开化。

如果 #4169 合并，下一轮 PR 的可信度会明显更高；如果 #4169 被要求缩小，也正好说明后续 PR Stack 要继续保持“小而硬”。
