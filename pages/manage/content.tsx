...
const contentCards = [
  ...
  {
    title: '社区记录',
    body: '活动复盘、成员故事和项目记录以 Notion Record 为唯一内容主源，并与前台使用同一 slug。',
    bullets: [
...
function ContentRevalidatePanel() {
  ...
  return (
    <section className='surface-card-strong p-5 sm:p-6'>
      ...
      <h2 className='mt-4 text-[1.35rem] font-semibold text-white'>
        Notion 发布后刷新前台
      </h2>
      <p className='mt-3 text-sm leading-7 text-white/60'>
        在 Notion
        新增或修改活动后，可以刷新首页和活动列表；如果改了某个详情页，再填活动
        slug 一起刷新。
      </p>
