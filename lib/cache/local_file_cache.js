...
import { getBuildSessionCacheRoot } from './build_session'

const CACHE_DIR = path.join(getBuildSessionCacheRoot(), 'data')

// Same default as cache_manager PROD_CACHE_TTL — keeps build-phase file cache
// from serving stale Notion data (e.g. S3 presigned URLs) across rebuilds.
