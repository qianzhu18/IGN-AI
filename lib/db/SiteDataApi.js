...
export async function fetchEventsFromOfficialAPI() {
  ...
  try {
    ...
    return removeUndefinedValues(events.map(page => mapOfficialEventPage(page, dataSource)))
  } catch (err) {
...
export async function fetchRecordsFromOfficialAPI() {
  ...
  try {
    ...
    return removeUndefinedValues(records.map(page => mapOfficialRecordPage(page, dataSource)))
  } catch (err) {
