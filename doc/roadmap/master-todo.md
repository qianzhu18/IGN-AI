...
- [x] 2026-08-02：官网 About 核心介绍同步官方飞书《IGNAI / 洋来社｜AI 社区合作介绍》revision 22，更新品牌关系与 300+ / 2000+ / 20+ 对外口径
...
- [ ] **P1 / 8.6** 官网内容层补齐：把官方介绍、合作方案、活动材料、成员故事、项目案例逐步转成可上架内容
  - [x] 2026-07-16：完成第一版对外展示内容母稿；首页、关于页、社区现场收束为“真实发生过什么 / 如何参与”的公众叙事，隐藏空的文章与成员入口，等待主理人第一轮审核。
  - [x] 2026-07-16：修复内容接线：首页 Field Notes 改为真实活动记录 slug；活动入口统一隐藏 mock、过期或无报名信息的 Notion Event，已发生内容归入“社区现场”。
  - [x] 2026-07-16：mock Event 从首页和活动页的服务端 page props 过滤，并阻断 mock 详情路由，避免旧 Notion 模板行继续出现在 HTML 数据或被直接访问。
  - [x] 2026-07-16：Event 封面补齐本地真实素材降级，Notion 临时图片失效时不再露出破图或生成式占位图。
  - [x] 2026-07-16：社区记录详情升级为图文叙事；从 `活动记录/assets/original` 筛选并压缩 16 张原始活动素材，按正文段落展示极客松、三人行、早期活动、共学营、吧唧项目、OpenClaw 与 LEV0 的现场证据。
...
- [x] 2026-08-02：完成 Notion 内容质量清理；14 条空 `ext` 与 4 条旧 Record JSON 已清空或迁移，重复 / 无依据 / 模板污染内容归档，Datawhale 与百万博主降级为待补证草稿，AIPO 与社区起源正文改为原生页面 blocks
...
- [ ] 首页 Hero / Header / CTA 品牌一致性后续细节继续打磨
  ...
  - [x] 2026-07-15：基于 Muku 视频转写方法论，首页 Hero 补强“理解-信任-行动”路径：文案更具体、二级 CTA 指向真实记录、首屏增加三类行动入口与 Trust Bar
