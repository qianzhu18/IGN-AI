...
你给的 2050 成员管理界面，本质上是后台管理系统。这个东西后续可以接，但 V1 不建议先做。
...
# 十五、V1 里保留成员预览，但不要做复杂

成员可以先放一个轻量区块，位置放在 Join 前。
...
```text
AI Builders
做 Agent、产品原型和自动化流程的人。

Product Explorers
从用户、场景和痛点出发，探索 AI 产品机会的人。

Storytellers
用文章、视频和社区记录传播高质量信号的人。

Local Connectors
连接长沙高校、开发者、创业者和线下空间的人。
```

等你们有真实成员头像和授权后，再升级成成员墙。
