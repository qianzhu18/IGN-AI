...
旧架构已打 tag `v1.0.0` 存档于 `codex/aesthetic-spacing-preview` 分支。新架构在 `notionnext-v2` 分支上开发。
...
```
✅ 1. 将当前代码全部提交到 codex/aesthetic-spacing-preview 分支
✅ 2. 打 tag v1.0.0，附注说明为"自建架构存档"
✅ 3. 创建新分支 notionnext-v2
...
*v2.0.0 分支：`notionnext-v2`*
*v1.0.0 存档：tag `v1.0.0` on `codex/aesthetic-spacing-preview`*
