...
module.exports = {
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type_member:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_MEMBER || 'Member', // 当type文章类型与此值相同时，为成员页。
    type_notice:
    ...
    type_event:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_EVENT || 'Event', // 当type文章类型与此值相同时，为活动/事件。
